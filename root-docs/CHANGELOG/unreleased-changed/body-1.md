...
- The package version moves to **0.8.0**, in step with the core and the
  specification.
- The PyPI sdist omits the spec corpus, tests and development-only docs/CI
  sources while retaining everything needed to build the wheel.
- The examples README is generated by Polydoc in English, Russian and Chinese.
